...
CREATE OR ALTER VIEW vw_FiltrosProveedores AS
SELECT 
...
CREATE OR ALTER VIEW vw_FiltrosInventarios AS
SELECT 
...
CREATE OR ALTER VIEW vw_FiltrosVentas AS
SELECT 
    'metodos_entrega' as tipo_filtro,
    DeliveryMethodName as valor,
    DeliveryMethodName as etiqueta
...
CREATE OR ALTER VIEW vw_FiltrosEstadisticas AS
...
CREATE OR ALTER VIEW vw_MetodosEntrega AS
SELECT 
    DeliveryMethodID,
    DeliveryMethodName
FROM Application.DeliveryMethods
...
CREATE OR ALTER VIEW vw_AniosDisponibles AS
SELECT 
    'ventas' as modulo,
...
CREATE OR ALTER PROCEDURE sp_GetCiudades
AS
BEGIN
    SELECT 
        CityID as id,
...
CREATE OR ALTER PROCEDURE sp_GetMetodosEntrega
AS
BEGIN
    SELECT 
